...
class TelefonesControllerTest < ActionController::TestCase
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post :create, telefone: { empresa_id: @telefone.empresa_id, numero: @telefone.numero, tipo: @telefone.tipo }
    end
  ...
  test "should update telefone" do
    patch :update, id: @telefone, telefone: { empresa_id: @telefone.empresa_id, numero: @telefone.numero, tipo: @telefone.tipo }
    assert_redirected_to telefone_path(assigns(:telefone))
  end
