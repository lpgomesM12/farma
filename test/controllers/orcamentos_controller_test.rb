...
class OrcamentosControllerTest < ActionController::TestCase
  ...
  test "should create orcamento" do
    assert_difference('Orcamento.count') do
      post :create, orcamento: { descricao: @orcamento.descricao, nome: @orcamento.nome, user_id: @orcamento.user_id }
    end
  ...
  test "should update orcamento" do
    patch :update, id: @orcamento, orcamento: { descricao: @orcamento.descricao, nome: @orcamento.nome, user_id: @orcamento.user_id }
    assert_redirected_to orcamento_path(assigns(:orcamento))
  end
