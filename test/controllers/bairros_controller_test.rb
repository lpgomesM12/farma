...
class BairrosControllerTest < ActionController::TestCase
  ...
  test "should create bairro" do
    assert_difference('Bairro.count') do
      post :create, bairro: { cidade_id: @bairro.cidade_id, latitude: @bairro.latitude, longitude: @bairro.longitude, nome: @bairro.nome }
    end
  ...
  test "should update bairro" do
    patch :update, id: @bairro, bairro: { cidade_id: @bairro.cidade_id, latitude: @bairro.latitude, longitude: @bairro.longitude, nome: @bairro.nome }
    assert_redirected_to bairro_path(assigns(:bairro))
  end
